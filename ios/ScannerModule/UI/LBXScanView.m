...
{
    //线动画
    if (!_scanLineAnimation) self.scanLineAnimation = [[LBXScanLineAnimation alloc]init];
    [_scanLineAnimation startAnimatingWithRect:self.scanRetangleRect
                                        InView:self
                                         Image:self.viewStyle.animationImage];
}
