...
/**
 @brief  矩形框线条颜色
 */
@property (nonatomic, strong) UIColor * _Nonnull colorRetangleLine;
...
//4个角的颜色
@property (nonatomic, strong) UIColor* _Nonnull colorAngle;
 ...
 */
@property (nonatomic, strong) UIColor * _Nonnull notRecoginitonArea;
